...
class _MyHomePageState extends State<Employer> {
  ...
  void getData() async {
    ...
    var memberEmployersMob = json.decode(response.body)['MemberEmployersMob'];
    var archivedMemberEmployersMob = json.decode(response.body)['ArchivedMemberEmployersMob'];
print(memberEmployersMob);
print(archivedMemberEmployersMob);
  }
